        ...
        <div className="flex w-full min-h-screen font-['Public_Sans',sans-serif] bg-white relative">
          ...
          <main className="flex-1 flex flex-col min-w-0 bg-white">
            ...
            <div className="flex flex-col p-6 w-full max-w-[1200px] mx-auto overflow-y-auto">
              ...
              <div className="mb-6">
                <button onClick={() => history.push('/usuario/documentos')} className="bg-[#050d2c] text-white flex items-center gap-2 px-6 py-2.5 rounded text-xs font-bold tracking-widest uppercase transition-colors hover:bg-[#0a184a]">
              ...
              <div className="flex justify-center mt-12 mb-8">
                <button onClick={() => history.push('/usuario/documentos')} className="bg-[#050d2c] text-white px-12 py-3.5 rounded text-xs font-bold tracking-widest uppercase transition-colors hover:bg-[#0a184a] shadow-lg shadow-blue-900/10">
                  Aceptar
                </button>
              </div>
