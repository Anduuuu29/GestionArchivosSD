        ...
        <div className="relative w-full min-h-screen flex flex-col font-['Inter',sans-serif] bg-[#f8f9fa]">
          ...
          <div className="flex-1 flex flex-col relative overflow-hidden items-center justify-center p-6 bg-[#eee]">
            ...
            <div className="absolute top-8 right-8 z-10 hidden md:block">
              <button onClick={() => history.push('/admin/login')} className="bg-[#050d2c] text-white px-6 py-4 rounded font-black text-sm tracking-[1.6px] uppercase hover:bg-[#0a184a] transition-colors shadow-lg">
            ...
            <div className="bg-white border border-[rgba(168,183,199,0.25)] rounded-lg shadow-xl w-full max-w-[448px] p-10 relative z-10">
              ...
              <div className="flex flex-col gap-6">
                ...
                {/* Login Button */}
                <button onClick={() => history.push('/dashboard-user')} className="bg-[#050d2c] hover:bg-[#0a184a] text-white rounded py-4 text-base font-black uppercase tracking-[1.6px] w-full mt-2 transition-colors shadow-[0px_8px_10px_-6px_rgba(96,236,168,0.1)]">
                  Ingresar
                </button>
              </div>
