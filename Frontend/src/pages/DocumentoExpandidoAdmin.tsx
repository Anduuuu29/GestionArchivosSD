...
const DocumentoExpandidoAdmin: React.FC = () => {
    ...
    <IonPage>
      <IonContent fullscreen>
        <div className="flex w-full min-h-screen font-['Public_Sans',sans-serif] bg-white relative">
            ...
            <div className="flex flex-1 overflow-hidden">
              ...
              <div className="flex-1 flex flex-col bg-[#f8f9fa] min-w-0">
                ...
                <div className="h-[60px] border-b border-gray-200 bg-white flex items-center px-6 justify-between shrink-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button onClick={() => history.push('/admin/documentos/detalles')} className="text-gray-500 hover:bg-gray-100 p-1.5 rounded transition-colors">
              ...
              <div className="w-[320px] lg:w-[400px] shrink-0 bg-white border-l border-gray-200 flex flex-col overflow-y-auto">
                ...
                <div className="p-6 flex flex-col gap-8">
                  ...
                  <button 
                    onClick={() => history.push('/admin/documentos/rechazar')}
                    className="flex items-center justify-center gap-2 border border-red-500 text-red-500 font-bold rounded-lg py-2.5 text-sm hover:bg-red-50 transition-colors"
                  >
          ...
          {showRejectModal && (
            <div className="absolute inset-0 bg-black/40 z-50 flex items-center justify-center backdrop-blur-sm animate-in fade-in duration-200">
              <div className="bg-white rounded-xl shadow-xl w-[500px] max-w-[90vw] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
                ...
                <div className="px-6 pb-6 flex flex-col gap-6">
                  ...
                  <div className="flex gap-4 pt-2">
                    <button 
                      onClick={() => setShowRejectModal(false)}
                      className="flex-1 bg-white border border-[#a8b7c7] text-[#121a34] font-medium py-2.5 rounded-lg text-sm hover:bg-gray-50 transition-colors"
                    >
                      Cancelar
                    </button>
                    <button className="flex-1 flex items-center justify-center gap-2 bg-[#9a1b24] text-white font-medium py-2.5 rounded-lg text-sm hover:bg-red-800 transition-colors">
...
export default DocumentoExpandidoAdmin;
