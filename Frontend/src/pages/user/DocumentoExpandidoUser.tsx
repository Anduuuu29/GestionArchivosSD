              ...
              <div className="flex-1 flex flex-col bg-[#f8f9fa] min-w-0">
                ...
                <div className="h-[60px] border-b border-gray-200 bg-white flex items-center px-6 justify-between shrink-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button onClick={() => history.push('/usuario/documentos/detalles')} className="text-gray-500 hover:bg-gray-100 p-1.5 rounded transition-colors">
...
export default DocumentoExpandidoUser;
