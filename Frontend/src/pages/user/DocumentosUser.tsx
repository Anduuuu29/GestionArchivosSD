              ...
              <div className="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col flex-1 min-h-0">
                <div className="overflow-x-auto overflow-y-auto flex-1">
                  <table className="w-full text-left border-collapse min-w-[900px]">
                    <thead className="sticky top-0 bg-[#ebedff] z-10 border-b border-[rgba(193,199,211,0.3)]">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      ...
                      <tr className="hover:bg-blue-50/50 transition-colors bg-blue-50/30">
                        ...
                        <td className="p-6 text-center">
                          <button onClick={() => history.push('/usuario/documentos/detalles')} className="p-1.5 text-[#00518e] hover:bg-gray-100 rounded transition-colors inline-flex">
                      ...
                      <tr className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="p-6">
                          <div className="inline-flex items-center gap-1.5 bg-[#ffdad8] px-3 py-1 rounded-full">
                            ...
                            <span className="text-[#8e101d] text-[10px] font-bold tracking-wider uppercase">Rechazado</span>
                          </div>
                        </td>
                        <td className="p-6 text-center">
                          <button onClick={() => history.push('/usuario/documentos/detalles')} className="p-1.5 text-[#00518e] hover:bg-gray-100 rounded transition-colors inline-flex">
                      ...
                      <tr className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="p-6">
                          <div className="text-[#121a34] text-[12px] font-medium whitespace-nowrap">
                            Modificación<br/>Planos
                          </div>
                        </td>
                        <td className="p-6">
                          <div className="text-[#414751] text-base">
                        ...
                        <td className="p-6">
                          <div className="inline-flex items-center gap-1.5 bg-[#e0e7ff] px-3 py-1 rounded-full">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#4f46e5]"></div>
                            <span className="text-[#3730a3] text-xs font-bold">Ingresado</span>
                          </div>
                        </td>
                        <td className="p-6 text-center">
                          <button onClick={() => history.push('/usuario/documentos/detalles')} className="p-1.5 text-[#00518e] hover:bg-gray-100 rounded transition-colors inline-flex">
